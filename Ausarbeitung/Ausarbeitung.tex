...
Im Ausgabeformat haben wir uns dazu entschieden, den Baum genau so darzustellen, wie er im Speicher mit Bits aussehen wurde. Folglich haben wir auf die Buchstaben und Leerzeichen wie im Beispiel verzichtet. In der nächsten Zeile steht die kodierte Bitsequenz der Quelldatei. %natürlich werden es evtl etwas mehr bity sein , da alles in bytes gespeichert wird aber
